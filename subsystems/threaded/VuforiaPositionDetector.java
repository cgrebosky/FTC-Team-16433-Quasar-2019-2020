...
final public class VuforiaPositionDetector extends ThreadSubSystem {
    ...
    private void startEngine() {
        ...
        for (VuforiaTrackable trackable : allTrackables) {
            ((VuforiaTrackableDefaultListener) trackable.getListener()).setPhoneInformation(setCamPosition(), parameters.cameraDirection);
        }

        targetsSkyStone.activate();
    }

    private void createTrackables() {
    ...
    private OpenGLMatrix setCamPosition() {
        //
        ...
        //For simplicities sake, I'm just using the phone as the center, not the robot center
        final float CAMERA_FORWARD_DISPLACEMENT  = 0f * mmPerInch;
        final float CAMERA_VERTICAL_DISPLACEMENT = 0f * mmPerInch;
    ...
    //The cycles go too fast since we don't have any FTC SDK overhead.
